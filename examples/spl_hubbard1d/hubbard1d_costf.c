...
int main()
{
	...
	sprintf(filename, "../examples/spl_hubbard1d/opt_out/q%i/spl_hubbard1d_%s_n%i_q%i_u%i_t%.2fs_g%.2f_norm.hdf5", nqubits, splitting, nlayers, nqubits, temp, t, g);
